...
<meta http-equiv="Refresh" content="3; Dashboard_id=maison1.php">
...
<body>
  ...
  <script type="text/javascript">
      ...
      if (prod_maison1[prod_maison1.length - 1] - conso[conso.length - 1].conso < 0) {
        document.getElementById('perc_rec').innerHTML = Math.abs(prod_maison1[prod_maison1.length - 1] - conso[conso.length - 1].conso) +" J";
        ...
        document.getElementById('perc_don').innerHTML = Math.abs(prod_maison1[prod_maison1.length - 1] - conso[conso.length - 1].conso) +" J";
